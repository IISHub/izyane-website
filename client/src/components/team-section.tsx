...
export default function TeamSection() {
  ...
  return (
    <section id="team" className="section-padding bg-slate-50 dark:bg-slate-900">
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {teamMembers.map((member, index) => (
            <div
              key={member.id}
              className="bg-white dark:bg-slate-800 rounded-2xl p-6 text-center card-hover animate-fadeInUp"
              ...
              <div className="flex justify-center space-x-3">
                {member.social.linkedin && (
                  <a
                    ...
                    className="w-10 h-10 bg-slate-100 dark:bg-slate-700 rounded-full flex items-center justify-center text-slate-600 dark:text-slate-300 hover:bg-primary-custom hover:text-white transition-all duration-200"
                  >
        ...
        {/* Team Stats */}
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 animate-fadeInUp">
